...
public class HolsDerGeier {
    ...
    */
     ...
     * @param nummer Nummer des Spielers, dessen letze Karte widergegeben werden soll.  
    */    
    ...
    public void naechsterZug() throws Exception {
       if (!nochZuVergebendeGeierKarten.isEmpty()) {
           ...
           if (zuege[0]!=zuege[1])              
               if (naechsteKarte>0)
                    if (zuege[0]>zuege[1])
                       punktstaende[0]=punktstaende[0]+naechsteKarte;
                    else 
                       punktstaende[1]=punktstaende[1]+naechsteKarte;
               else
                    if (zuege[0]<zuege[1])
                       punktstaende[0]=punktstaende[0]+naechsteKarte;
                    else 
              ...
              System.out.println("Unentschieden - keine Punkte fuer niemand");
